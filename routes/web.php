...
Route::post('/messagesread', 'MessageController@read')->name('messages.read');
Route::get('/messagesreply/{id}', 'MessageController@reply')->name('messages.reply');
Route::post('/messagesuserajax', 'MessageController@getName')->name('messages.getName');
Route::post('/messagesdeleteajax', 'MessageController@delete')->name('messages.delete');

Route::resource('/advancedsearch','AdvancedSearchController');
//Route::resource('/advancedsearch1/{text}','AdvancedSearchController@search')->name('advancedsearch1.search');
//Route::get('/advancedsearch/{text}','AdvancedSearchController@index');
