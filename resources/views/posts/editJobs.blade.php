    ...
    <form name="Jobs" class="border border-light p-5" action="/addAttributes" method="post" enctype="multipart/form-data" onsubmit="return validateform()">
        ...
        <div class="form-row justify-content-center align-items-center">
            <div class="col-5">
                ...
                <input type="text" id="textInput" class="form-control mb-4" placeholder="Enter your Phone Number(optional)" name="Phone_Number" value="@isset($postData["Phone_Number"]){{ old('title', $postData["Phone_Number"] ) }}@endisset">
