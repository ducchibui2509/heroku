        ...
        <div class="form-row justify-content-center align-items-center">
            <div class="col-5">
                ...
                <div id="Edit" class="content">
                    <p>Never fear! Almost any part of your ad can be edited with only a few clicks.</p>


                    <h2><span style="font-size: 18px;"><b>What Can’t Be Edited</b></span></h2>

                    <p>There are 2 parts of an ad that cannot be edited once it has been posted on the site. Here’s how to deal with each of those sections:</p>
                    ...
                    <p style="margin-left: 40px;">There is no way to move an ad from one share square account to another. To change the email that is linked to your ad, you will need to change the email linked to your entire account.</p>

                    <p style="margin-left: 40px;">To post an ad under a different registered share square account, you will need to delete the ad and repost it after logging into the correct account.</p>


                    <h2><span style="font-size: 18px;"><b>Unable to Edit Price, and Other Editing Issues</b></span></h2>

                    <p>If you’re having trouble editing a section of your ad not mentioned in the list above, it may be due to the information that you’re trying to enter.</p></span>
                </div>
...
<p><b>Note:</b> Some features can be purchased for 3, 7 or 30 days. Once selected, the price will update accordingly. To learn more about features, <a href="#" target="_blank">read our Benefits of Promoting Ads article</a>.</p></span>
            </div>
