    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link waves-effect" href="{{ URL::to('help')}}"
    ...
    <div class="container dark-grey-text mt-5">
                ...
                <div id="carousel-example-1z" class="carousel slide carousel-fade carousel-fade" data-ride="carousel">
                    ...
                    <div class="carousel-inner z-depth-1-half" role="listbox">
                        ...
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('photos/'.$postData["images"][0]) }}" alt="First slide" style= "max-height:350px;max-width:700px;">
                        </div>
                        <!--/First slide-->
                        <!--Second slide-->
                        @for($i=1;$i<$postData["images"]->count();$i++)
                            ...
                            <div class="carousel-item">
                                <img class="d-block w-100" src="{{ asset('photos/'.$postData["images"][$i]) }}" style= "max-height:350px;max-width:700px;">
                            </div>
                            }
                        @endfor
                    </div>
        ...
        <div class="row wow fadeIn">
            ...
            @foreach($postData as $key => $value)
                @if($key != 'post_id' and $key != 'post_category' and $key != 'title' and $key!='images' and $key!='Description')
